...
private:
    ...
    std::array<Joint, 6>
        joints_{
            ...
            Joint{Angle{-180.0}, Angle{180.0}, AngularVelocity{60.0}, AngularAcceleration{30.0}, motors_[2]},
            Joint{Angle{-180.0}, Angle{180.0}, AngularVelocity{60.0}, AngularAcceleration{30.0}, motors_[3]},
